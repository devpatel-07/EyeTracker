 ...
 * Arduino CLI: sketch lives in espfirmware/espfirmware.ino (keep in sync with this file).
 *   arduino-cli compile --fqbn esp32:esp32:esp32 espfirmware
 *   arduino-cli upload -p /dev/cu.usbserial-10 --fqbn esp32:esp32:esp32 \
 *     --board-options UploadSpeed=115200 espfirmware
 * (Use 115200 upload if 921600 fails; replace port after arduino-cli board list.)
 *
 * Serial: 115200, newline-terminated lines (Serial Monitor: set "Both NL & CR" or "Newline").
 */
